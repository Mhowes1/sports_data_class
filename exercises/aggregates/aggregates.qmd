...
```
**Each player is listed from the past season, with background information from their age, team and games players, to stats like points, rebounds and assists, as well as more advanced stats like usage and wins shares. ** DESCRIBE THE RESULTS HERE
...
**It shows the total number of players per position throughout the league. There is no order, as centers which are middle of the pack start the list and shooting guards which are the most common are the least.  ** DESCRIBE THE RESULTS HERE
...
**This now shows the data in descending order --- different from the first. Still, it shows shooting guards were the most common position in the league while power forwards were the least common position in the league. ** HOW WOULD YOU DESCRIBE THE RESULTS?
...
**The power forward position is especially interesting to me because, based on the data, they log fewer total minutes than guards but still carry a workload similar to centers. With an average of about 894 minutes, they sit between small forwards (863) and centers (856), which reinforces the idea of power forwards as a “tweener” role bridging the frontcourt. A possible story would be to look more closely at the top power forwards and compare their production efficiency to both centers and small forwards, since the data suggest they’re balancing responsibilities of scoring, rebounding, and defending without logging as many total minutes as guards. ** 
