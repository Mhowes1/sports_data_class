...
top_positions <- positions_standardized |>
count(position_title_standardized, sort = TRUE) |>
slice_head(n = 3)
...
Answer: There are definitely patterns. Most compound titles are just an assistant coach carrying multiple responsibilities, like recruiting or positional coaching, stacked into one line. We also see a lot of hybrid admin-support roles, such as analytics, scouting, team management bundled together because smaller staffs spread duties across one person.
...
Answer:  These “Other” titles actually break into a few clean buckets. Most are admin or support roles, like interns, staff and fellows, that just aren’t coaching-specific, and a handful are higher-level athletic-department jobs like “Athletic Director” or “Assistant Athletic Director” that we probably don’t want lumped in with coaching roles. 

A couple --- like “Director of Player Personnel” or “Coordinator of Basketball Operations” --- should be absorbed into existing categories with a quick regex update.
